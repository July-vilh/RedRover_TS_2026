...
const ourYear: number = 1998;
if(ourYear % 4 !== 0 ){
     console.log('Год НЕ високосный')
} else if (ourYear % 100 !== 0){
     console.log('Год високосный')
} else if (ourYear % 400 === 0){
     console.log('Год високосный')
} else {
     console.log('Год НЕ високосный')
}
...
/*
13. Создайте программу, которая определяет, имеет ли человек право на определенное мероприятие, на основе нескольких критериев: возраста, статуса членства и посещения предыдущих мероприятий.
    Критерии участия:
...
const age: number = 18;
const countOfEvent: number = 5;
const isTeamMember: boolean = false;
...
if (age < 18) {
    ...
    } else if (countOfEvent >= 5) {
        console.log("You get special VIP status");
    } else if (countOfEvent >= 3) {
        console.log("You have access");
    } else {
